...
//     const [cartNum, setCartNum] = useState(wishStorage.length); // Initialize cartNum
...
//         setCartNum(updatedWishStorage.length); // Update cartNum
//     };

//     useEffect(() => {
//         // Optional: Sync cartNum with the length of wishStorage whenever it changes
//         setCartNum(wishStorage.length);
//     }, [wishStorage]);

//     return (
//         <>
//             <Navbar cartNum={cartNum} /> {/* Pass cartNum to Navbar */}
//             <div className="mb-3">
//                 <div className="font-sans bg-white max-w-6xl mx-auto p-4">
...
//                                                 type="button"
//                                                 className="bg-transparent border flex items-center justify-center w-11 h-10 rounded-lg"
//                                                 onClick={() => handleRemove(c.id)} // Call the remove function
//                                             >
//                                                 <svg xmlns="http://www.w3.org/2000/svg" className="w-4 fill-red-500 inline" viewBox="0 0 24 24">
//                                                     <path
