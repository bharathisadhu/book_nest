...
export default function BooksCard({ book }) {
  ...
  return (
    <div className="transition h-fit duration-500 w-full font-sans overflow-hidden mx-auto mt-4 pl-4 pt-4 hover:scale-105">
      {/* Full Height Image */}
      <div className="w-full h-48 relative">
        <Image
          ...
          layout="fill"
          objectFit="cover"
          className="rounded-t-lg hover:scale-105 transition duration-500"
        />
      ...
      <div className="p-4">
        ...
        <h3 className="text-xl md:text-2xl text-gray-800 font-bold my-2">
          ${price.toFixed(2)}
        </h3>
