...
export async function POST() {
    ...
    try {
       ...
       const init_url='https://sandbox.sslcommerz.com/gwprocess/v3/api.php';
        ...
        formData.append("store_passwd", "growt670dff341c48a@ssl@ssl");
        ...
        formData.append("cus_name",'Mohammad Azad');
        formData.append("cus_email",'jrazad10@gmail.com');
        ...
        formData.append('ship_name','Mohammad Azad');
