    ...
    <div className="container mx-auto p-6">
      ...
      <div className="mt-24 container space-y-12 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-x-8">
        ...
        <div className="relative p-8 border border-gray-200 rounded-2xl shadow-sm flex flex-col">
          <div className="flex-1">
            ...
            <ul className="mt-6 space-y-6">
              ...
              <li className="flex">
                ...
                <span className="ml-3">Stock Status and Pre-Order Options</span>
              </li>
              <li className="flex">
                <svg className="flex-shrink-0 w-6 h-6 text-emerald-500">
                  <polyline points="20 6 9 17 4 12" />
          ...
          <button
            className="bg-emerald-600 text-white hover:bg-emerald-700 mt-8 block w-full py-3 px-6 rounded-md font-medium"
...
//     if (data.url) {
//       // Show success alert before redirecting to checkout
//       Swal.fire({
//         title: "Congratulations!",
//         text: `Thank you for being our ${
//           plan === "pro" ? "Pro" : "Free"
//         } user!`,
//         icon: "success",
...
//                   <polyline points="20 6 9 17 4 12" />
//                 </svg>
//                 <span className="ml-3">Live Chat Support</span>
//               </li>
//             </ul>
//           </div>
//           <button
