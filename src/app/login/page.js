...
export default function Login() {
  ...
  const {
    ...
    handleSubmit,
    reset,
    setValue, // Import setValue to set input values programmatically
    formState: { errors },
  } = useForm();
  ...
  const handleAdminLogin = () => {
    // Set admin credentials into form fields
    setValue("email", "admin@admin.com");
    setValue("password", "admin@admin.com");
    // Submit the form
            ...
            <div className="flex w-full flex-col justify-center shadow-2xl shadow-orange-50 space-y-6 my-4">
              ...
              >
                ...
                <button
                  ...
                  className="w-full rounded-lg bg-orange-400 px-6 py-2 font-bold text-white "
                >
                  Admin Login
                </button>
              </form>
